/**
 * data.h
 * Font data for SSD1306 OLED display
 *
 ...
 * ATTRIBUTION:
 * ============
 * Part of the SSD1306 driver by osch
 *
...
// ============================================================================
// GRAFISKE IKONER TIL METALDETEKTION (32x24 pixels = 3 sider x 32 bytes)
// ============================================================================

// FERRO ikon - Hestesko magnet form (32x24)
const prog_uchar icon_ferro[96] PROGMEM = {
    // Side 0 (øverste 8 rækker)
    0x00,0x00,0x00,0xF0,0xF8,0xFC,0xFE,0x0E,0x06,0x06,0x06,0x06,0x00,0x00,0x00,0x00,
    0x00,0x00,0x00,0x00,0x06,0x06,0x06,0x06,0x0E,0xFE,0xFC,0xF8,0xF0,0x00,0x00,0x00,
    // Side 1 (midterste 8 rækker)
    ...
    // Side 2 (nederste 8 rækker)
    0x00,0x00,0x00,0x1F,0x3F,0x7F,0x7F,0x70,0x60,0x60,0x60,0x60,0x60,0x60,0x60,0x60,
    0x60,0x60,0x60,0x60,0x60,0x60,0x60,0x60,0x70,0x7F,0x7F,0x3F,0x1F,0x00,0x00,0x00
};

// NON-FERRO ikon - Mønt/cirkel med stjerne (32x24)
const prog_uchar icon_nonferro[96] PROGMEM = {
    // Side 0 (øverste 8 rækker)
    0x00,0x00,0xC0,0xF0,0xF8,0x3C,0x1C,0x0E,0x0E,0x06,0x86,0xC6,0xE6,0x66,0x66,0x66,
    0x66,0x66,0xE6,0xC6,0x86,0x06,0x0E,0x0E,0x1C,0x3C,0xF8,0xF0,0xC0,0x00,0x00,0x00,
    // Side 1 (midterste 8 rækker)
    0x00,0x3F,0xFF,0xFF,0xC0,0x00,0x00,0x00,0x00,0x00,0x03,0x07,0x0F,0x3E,0xFC,0xFC,
    0xFC,0x3E,0x0F,0x07,0x03,0x00,0x00,0x00,0x00,0x00,0xC0,0xFF,0xFF,0x3F,0x00,0x00,
    // Side 2 (nederste 8 rækker)
    0x00,0x00,0x03,0x0F,0x1F,0x3C,0x38,0x70,0x70,0x60,0x61,0x63,0x67,0x66,0x66,0x66,
    0x66,0x66,0x67,0x63,0x61,0x60,0x70,0x70,0x38,0x3C,0x1F,0x0F,0x03,0x00,0x00,0x00
};

// SØGE ikon - Radar sweep (32x24)
const prog_uchar icon_search[96] PROGMEM = {
    // Side 0 (øverste 8 rækker)
    0x00,0x00,0x00,0x80,0xC0,0xE0,0x60,0x30,0x30,0x18,0x18,0x0C,0x0C,0x0C,0x06,0x06,
    0x06,0x0C,0x0C,0x0C,0x18,0x18,0x30,0x30,0x60,0xE0,0xC0,0x80,0x00,0x00,0x00,0x00,
    // Side 1 (midterste 8 rækker)
    0x00,0x3E,0xFF,0xC1,0x00,0x00,0x00,0xC0,0xE0,0xF0,0x38,0x1C,0x0E,0x06,0x03,0x03,
    0x03,0x06,0x0E,0x1C,0x38,0xF0,0xE0,0xC0,0x00,0x00,0x00,0xC1,0xFF,0x3E,0x00,0x00,
    // Side 2 (nederste 8 rækker)
    0x00,0x00,0x00,0x01,0x03,0x07,0x06,0x0F,0x1F,0x1F,0x18,0x30,0x30,0x30,0x60,0x60,
    0x60,0x30,0x30,0x30,0x18,0x1F,0x1F,0x0F,0x06,0x07,0x03,0x01,0x00,0x00,0x00,0x00
};

// Fremgangsbar segmenter (8 pixels høje hver)
const prog_uchar bar_empty[8] PROGMEM = {0x00,0x7E,0x42,0x42,0x42,0x42,0x7E,0x00};
const prog_uchar bar_low[8] PROGMEM =   {0x00,0x7E,0x42,0x5A,0x5A,0x42,0x7E,0x00};
const prog_uchar bar_med[8] PROGMEM =   {0x00,0x7E,0x5A,0x5A,0x5A,0x5A,0x7E,0x00};
const prog_uchar bar_full[8] PROGMEM =  {0x00,0x7E,0x7E,0x7E,0x7E,0x7E,0x7E,0x00};
