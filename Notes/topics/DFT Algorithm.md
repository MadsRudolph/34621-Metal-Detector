...
Since we sample at **exactly 4× the signal frequency** (8 kHz sampling, 2 kHz signal), the sine and cosine values become trivial:
...
This means **no trigonometric calculations needed!**
